...
class LotteryThreeDigitPivot extends Model
{
    ...
    protected $fillable = ['result_date_id', 'lotto_id', 'three_digit_id', 'user_id', 'bet_digit', 'sub_amount', 'prize_sent', 'match_status', 'res_date', 'res_time', 'match_start_date', 'admin_log', 'user_log'];
