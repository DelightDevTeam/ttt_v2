            ...
            @foreach($reports as $report)
                <tr>
                    ...
                    <td>{{ $report->total_amount }}</td>
                     <td>
                      <a href="{{ route('admin.3dReportShow', $report->running_match) }}" class="btn btn-info btn-sm">Detail</a>
                       <a href="{{ route('admin.3dLegarShow', $report->running_match) }}" class="btn btn-warning btn-sm">လယ်ဂျာ</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
