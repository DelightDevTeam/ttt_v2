 ...
 <div class="col-12">
  <div class="card">
   ...
   <div class="card-header pb-0">
    <div class="d-lg-flex">
     <div>
      <h5 class="mb-0">2D Evening Slip (ဘောင်ချာ) User တဦးချင်း၏ အသေးစိပ်မှတ်တမ်း Dashboards</h5>
   ...
   <div class="table-responsive">
    ...
    <a href="{{ route('admin.EveningSlipIndex') }}" class="btn btn-secondary">Back to List</a>
</div>
   
  </div>
  <div class="card mt-2">
    <div class="card-header">
     <p class="text-center">Total Amount 2D Evening History</p>
    </div>
    <div class="card-body">
     <div>
